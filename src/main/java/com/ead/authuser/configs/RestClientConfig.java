...
public class RestClientConfig {
    ...
    //sempre que enviar solicitaçoes para outros clientes, ele vai esperar esse intervalo de tempo
    //se passar ,ele irá enviar um erro de time out que ecedeu o tempo de limite
